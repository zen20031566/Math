...
[CustomEditor(typeof(PoiBindDataBaker))]
public class PoiBindDataBakerEditor : Editor
{
    ...
    {
        PoiBindDataBaker baker = (PoiBindDataBaker)target;
    ...
    public void SettingsPanel()
    {
        ...
        PoiBindDataBaker.BindDataUVSlot bindPositionsSlot = (PoiBindDataBaker.BindDataUVSlot)EditorGUILayout.EnumPopup("Bind Positions Output UV Channel", baker.GetBindPositionsUVSlot());
        PoiBindDataBaker.BindDataUVSlot bindNormalsSlot = (PoiBindDataBaker.BindDataUVSlot)EditorGUILayout.EnumPopup("Bind Normals Output UV Channel", baker.GetBindNormalsUVSlot());
        PoiBindDataBaker.BindDataUVSlot bindTangentsSlot = (PoiBindDataBaker.BindDataUVSlot)EditorGUILayout.EnumPopup("Bind Tangents Output UV Channel", baker.GetBindTangentsUVSlot());
        ...
        if(newMaskColors.Length != PoiBindDataBaker.cMaxMaskColors)
        {
            newMaskColors = new Color[PoiBindDataBaker.cMaxMaskColors];
        ...
        if (newMask != null)
        {
            ...
            if (GUILayout.Button("+"))
            {
                if(newMaskColorCount < PoiBindDataBaker.cMaxMaskColors)
                {
                    newMaskColorCount++;
                }
                else
                {
                    mErrorMessage = "Maximum number of subregions is " + PoiBindDataBaker.cMaxMaskColors + "!";
                }
            }
