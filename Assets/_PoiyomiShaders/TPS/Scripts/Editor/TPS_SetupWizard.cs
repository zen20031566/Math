...
#region GUI
        ...
        class Prefab
        {
            ...
            public UnityEditor.Editor EditorObject;
            ...
            public Texture2D GetTexture()
            {
                ...
                EditorObject = UnityEditor.Editor.CreateEditor(temp);
                Texture = EditorObject.RenderStaticPreview(AssetDatabase.GetAssetPath(GameObject), null, 200, 200);
                if (!Texture) Texture = EditorGUIUtility.whiteTexture;
                EditorWindow.DestroyImmediate(EditorObject);
